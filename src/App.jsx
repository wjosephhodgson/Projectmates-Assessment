...
// Import your products data
import initialProducts from './Products.json' with { type: 'json' };
    ...
    <Card sx={{ mb: 2, boxShadow: 2 }}>
      <CardContent>
        ...
        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mb: 1 }}>
          ...
          <Chip label={`Cat: ${product.catId}`} size="small" color="primary" variant="outlined" />
          <Chip label={product.uom} size="small" color="secondary" variant="outlined" />
        </Box>
